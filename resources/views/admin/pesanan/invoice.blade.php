                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-12 col-sm-5 text-grey text-90 order-first order-sm-last">                                
                                <div class="row my-2 align-items-center bgc-primary-l3 p-2">
                                    ...
                                    <div class="col-7">
                                        <span class="text-150 text-success-d3">{{ AllHelper::rupiah_v2($invoice->pengiriman->biaya) }}</span>
                                    </div>
                                    <div class="col-5 text-right">
                                        Total Pembayaran
                                    </div>
                        ...
                        <div>
                            ...
                            @if(Auth::user()->role == 'admin')
                                @if(Request::segment(3)=='selesai')
                                    <a href="{{ route('admin.pesanan.selesai') }}" class="btn btn-info btn-bold text-white px-4 float-right mt-3 mt-lg-0">Kembali</a>
                                @elseif(Request::segment(3)=='batal')
                                    <a href="{{ route('admin.pesanan.batal') }}" class="btn btn-info btn-bold text-white px-4 float-right mt-3 mt-lg-0">Kembali</a>
                                @else
                                    <a href="{{ route('admin.pesanan') }}" class="btn btn-info btn-bold text-white px-4 float-right mt-3 mt-lg-0">Kembali</a>
                                @endif
                            @elseif(Auth::user()->role == 'petani')
                                @if(Request::segment(3)=='selesai')
                                    <a href="{{ route('petani.pesanan.selesai') }}" class="btn btn-info btn-bold text-white px-4 float-right mt-3 mt-lg-0">Kembali</a>
                                @elseif(Request::segment(3)=='batal')
                                    <a href="{{ route('petani.pesanan.batal') }}" class="btn btn-info btn-bold text-white px-4 float-right mt-3 mt-lg-0">Kembali</a>
                                @else
                                    <a href="{{ route('petani.pesanan') }}" class="btn btn-info btn-bold text-white px-4 float-right mt-3 mt-lg-0">Kembali</a>
                                @endif
                            @endif
                        </div>
