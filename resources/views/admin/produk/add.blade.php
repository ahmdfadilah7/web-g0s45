...
@section('content')
    ...
    <div class="section-header">
        <div class="section-header-back">
            <a href="{{ route('petani.produk') }}" class="btn btn-icon"><i class="fas fa-arrow-left"></i></a>
        </div>
        <h1>Produk</h1>
        <div class="section-header-breadcrumb">
            <div class="breadcrumb-item"><a href="{{ route('petani.produk') }}">Produk</a></div>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    {!! Form::open(['method' => 'post', 'route' => ['petani.produk.store'], 'enctype' => 'multipart/form-data']) !!}
                        ...
                        <div class="col-sm-12 col-md-7">
                            <select name="kategori" class="form-control selectric">
                                ...
                                @foreach ($kategori as $row)
                                    <option value="{{ $row->id }}" @if(old('kategori')==$row->id) selected @endif>{{ $row->kategori }}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="form-group row mb-4">
                        ...
                        <div class="col-sm-12 col-md-7">
                            <div class="input-group">
                                ...
                                <input type="text" name="harga" class="form-control currency" value="{{ old('harga') }}">
                            </div>
