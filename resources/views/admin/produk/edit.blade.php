    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    {!! Form::model($produk, ['method' => 'post', 'route' => ['petani.produk.update', $produk->id], 'enctype' => 'multipart/form-data']) !!}
                    @method('PUT')
                    ...
                    <div class="form-group row mb-4">
                        ...
                        <div class="col-sm-12 col-md-7">
                            <div class="input-group">
                                ...
                                <input type="text" name="harga" class="form-control currency" value="{{ $produk->harga }}">
                            </div>
